...
/// ViewModel handling the introduction slides configurations.
class IntroScreenViewmodel {
  List<PageViewModel> get pages => [
        PageViewModel(
          title: "Benvenuti a Bella Vita",
          body: "Siamo un ristorante italiano specializzato in piatti di carne di alta qualità.",
          image: Center(
        ...
        PageViewModel(
          ...
          body: "Crediamo che la buona cucina debba essere fatta con ingredienti di qualità e con amore.",
          image: Center(
        ...
        PageViewModel(
          title: "Vi aspettiamo",
          body: "Vieni a trovarci e scopri la nostra selezione di piatti e vini selezionati.",
          image: Center(
